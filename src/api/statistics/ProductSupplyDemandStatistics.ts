 ...
 * @LastEditTime: 2023-08-18 17:06:45
 ...
 * @return
 */
export function batchDeleteProductSupplyDemandStatistics(ids: string) {
  return defHttp.delete<ProductSupplyDemandStatistics>(
    { url: Api.ProductSupplyDemandStatistics + "/batch?ids=" + ids },
    { successMessageMode: "message" },
  );
}
