            ...
            :actions="[
              {
                ...
                auth: 'sys:marketStatistics:update',
                tooltip: '修改',
              },
              {
                ...
                auth: 'sys:marketStatistics:delete',
                tooltip: '删除',
              },
            ]"
          />
...
<script lang="ts">
  ...
  import { uploadExcel } from "/@/api/statistics/MarketStatistics";
  ...
  export default {
    ...
    setup() {
      ...
      function handleDelete(record: Recordable) {
        deleteMarketStatistics(record.id).then(() => {
          handleSuccess();
        });
      }
